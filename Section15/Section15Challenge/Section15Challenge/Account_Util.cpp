...
void Account_Util::display(const std::vector<Trust_Account>& accounts) {
...
void Account_Util::deposit(std::vector<Trust_Account>& accounts, double amount) {
...
void Account_Util::withdraw(std::vector<Trust_Account>& accounts, double amount) {
